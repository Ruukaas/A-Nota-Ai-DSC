...
public class LojaJPQL extends BaseTests {
    ...
    public void quantidadeProdutosHyperFood() {
        ...
        query = em.createQuery(
                "SELECT l.codigo, p.nome FROM Loja l JOIN l.produtos p WHERE l.nome = 'Hyper food'",
                Object[].class
            );
    ...
    public void ordenacaoLojaNome() {
        ...
        TypedQuery<Object[]> query;
        query = em.createQuery(
                "SELECT l.codigo, l.nome FROM Loja l ORDER BY l.nome ASC",
                Object[].class
            );
